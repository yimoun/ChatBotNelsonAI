...
export function createChatWindow(theme) {
...
export function createChatHeader(theme) {
...
export function createMessagesContainer(theme) {
...
export function createChatInput(theme) {
